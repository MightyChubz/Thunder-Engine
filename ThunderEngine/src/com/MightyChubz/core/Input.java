...
public class Input extends GLFWKeyCallback {
    ...
    public static final int THUNDER_1 = GLFW_KEY_M;
    public static final int THUNDER_2 = GLFW_KEY_M;
    public static final int THUNDER_3 = GLFW_KEY_M;
    public static final int THUNDER_4 = GLFW_KEY_M;
    public static final int THUNDER_5 = GLFW_KEY_M;
    public static final int THUNDER_6 = GLFW_KEY_M;
    public static final int THUNDER_7 = GLFW_KEY_M;
    public static final int THUNDER_8 = GLFW_KEY_M;
    public static final int THUNDER_9 = GLFW_KEY_M;
    public static final int THUNDER_0 = GLFW_KEY_M;
